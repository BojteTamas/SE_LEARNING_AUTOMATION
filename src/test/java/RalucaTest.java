...
public class RalucaTest {
   ...
   public void forthTest(){
    ...
    public void fifthTest(){
        ...
        colorTheElementInRed(editprofbutton);
...
public class RalucaTest {
    ...
    public void colorTheElementInGreen(final WebElement webElement){
        chromeDriver.executeScript("arguments[0].style.border='3px solid green'", webElement);
    }
